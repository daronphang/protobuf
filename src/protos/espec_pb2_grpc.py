...
def add_ESPECServicer_to_server(servicer, server):
    rpc_method_handlers = {
...
class ESPEC(object):
    ...
    def heartbeat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ESPEC/heartbeat',
    ...
    def task(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ESPEC/task',
    ...
    def taskStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ESPEC/taskStatus',
